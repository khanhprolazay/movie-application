  ...
  return (
    <footer className="relative bg-cblack-100 border-t border-t-divider">
      <AppContainer className="px-4">
        ...
        <div className="mt-12 flex w-full flex-col items-center justify-center border-t border-t-divider py-4 md:flex-row md:justify-between">
          <Typography
            variant="small"
            className="mb-4 text-center font-normal text-white md:mb-0"
          >
            &copy; {currentYear}{" "}
            <span className="text-cred">TMT Movie</span>. All
            Rights Reserved.
          </Typography>
