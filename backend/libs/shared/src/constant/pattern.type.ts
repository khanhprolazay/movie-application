...
export type MoviePattern = BasePattern<"MOVIE"> | "MOVIE.GET_BY_YEAR" | "MOVIE.GET_BY_RATING" | "MOVIE.GET_BY_GENRES" | "MOVIES.GET_BY_DAY";
...
export const PatternOption: PatternOptionType = {
  ...
  "MOVIES.GET_BY_DAY": "MOVIES.GET_BY_DAY",
